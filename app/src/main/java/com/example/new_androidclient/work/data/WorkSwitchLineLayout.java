 ...
 */
public class WorkSwitchLineLayout extends RelativeLayout {
    int pos;
    TextView name;
    TextView nameText;
    EditText editText;
    ...
    public WorkSwitchLineLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public WorkSwitchLineLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public WorkSwitchLineLayout(Context context, int pos) {
        super(context);
        this.pos = pos;
    }

    public WorkSwitchLineLayout init(int type) {
        this.type = type;
        switch (type) {
            case 1: //textView
            ...
            case 3: //editText
                ...
                break;
            case 4: //Switch
                LayoutInflater.from(getContext()).inflate(R.layout.item_check_message, this, true);
                name = findViewById(R.id.work_item);
