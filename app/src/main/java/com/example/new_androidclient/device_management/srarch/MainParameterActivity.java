 ...
 * 主要参数详情
 */
public class MainParameterActivity extends BaseActivity {
    ...
    private List<DeviceSpecBean.Parm0Bean> list;
    private MainParameterAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_parameter);
        ...
        RetrofitUtil.getApi().selectDeviceSpec(deviceCode)
                ...
                .subscribe(new DialogObserver<DeviceSpecBean>(mContext, true, "正在获取数据") {
                    ...
                    public void onSuccess(DeviceSpecBean bean) {
                        if (bean != null) {
                            list = new ArrayList<>();
                            if (bean.getParm0() != null){
                                list.addAll(bean.getParm0());
                            }else {
    ...
    private void setBasicValue(List<DeviceSpecBean.Parm0Bean> bean) {
        adapter = new MainParameterAdapter(mContext, bean);
