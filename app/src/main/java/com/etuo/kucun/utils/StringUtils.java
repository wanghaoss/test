...
public class StringUtils {
    ...
    public static Object NullToObject(Object o) {
        if (null == o || org.json.JSONObject.NULL == o || "null" == o) {
            return null;
        }
        return o;
    }
    ...
    public static String NullToStr(Object o) {
        if (null == o || null == o.toString() || org.json.JSONObject.NULL == o) {
            return "";
        }
        return o.toString();
    }
    ...
    public static int NullToInt(Object o) {
        if (null == o || null == o.toString() || "".equals(o) || org.json.JSONObject.NULL == o) {
            return 0;
        }
    ...
    public static double NullToDouble(Object o) {
        if (null == o || null == o.toString() || org.json.JSONObject.NULL == o || o.equals("")) {
            return 0;
        }
    ...
    public static boolean NullToBoolean(Object o) {
        if (null == o || org.json.JSONObject.NULL == o) {
            return false;
        }
        return (Boolean) o;
    }
     ...
     * 使用java正则表达式去掉之前的零
     **/
    public static String deleteBeforeZero(String str) {
        if (StringUtils.isEmpty(str.replace("0", ""))) {
            return "0";
        }
        // 取得字符串的长度
        int len = str.length();
    ...
    /**
     * @param oriStr 待转换的字符串
     * @return 转换后的字符串
     */
    public static String toUTF8(String oriStr) {
        String tmpPath = new String("");
        try {
            String path = oriStr.substring(0, oriStr.lastIndexOf("/") + 1);
            String fname = oriStr.substring(oriStr.lastIndexOf("/") + 1, oriStr.length());
            tmpPath = path + URLEncoder.encode(fname, "utf-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return tmpPath;
    ...
    public static String decode(String oriStr) {
        String tmp = "";
        try {
            tmp = URLDecoder.decode(oriStr, "utf-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
...
//    }
     ...
     * 字符串的非空判断
     **/
    public static boolean stringThreeNotEmpty(String content) {
        return content != null && !"".equals(content) && !content.isEmpty();
    }
