...
public class TpBomDetailsActivity extends BaseActivity implements TpBomDetailsAdapter.OnClickBtItem {
    ...
    private TpBomDetailsAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        getData(true, true);
        mAdapter = new TpBomDetailsAdapter(this, fromType);
                ...
                .execute(new DialogCallback<LzyResponse<BomDetailsModel>>(this, "加载中..") {
                    ...
                    public void onSuccess(LzyResponse<BomDetailsModel> responseData, Call call, Response response) {
                        ...
                        if (null != responseData) {
                            ...
                            orderNum = mOutBoundModel.getStorageOutNo();
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        ...
                        ShowToast.tCustom(TpBomDetailsActivity.this, e.getMessage());
                    }
                });
    ...
    public void upLoadOrderComfrim() {
        ...
        OkGo.post(UrlTools.getInterfaceUrl(GOODS_STORAGEOUT_UPDATEBILL))
                ...
                .execute(new DialogCallback<LzyResponse<String>>(this, "加载中..") {
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        super.onError(call, response, e);
                        ShowToast.tCustom(TpBomDetailsActivity.this, NullToStr(e.getMessage()));
                    }
                });
    }
        ...
        OkGo.post(UrlTools.getInterfaceUrl(MOBILE_GOODS_STORAGEOUT))
                ...
                .execute(new DialogCallback<LzyResponse<String>>(this, "加载中..") {
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        ...
                        ShowToast.tCustom(TpBomDetailsActivity.this, e.getMessage().toString());
                    }
                });
    }
