...
import com.etuo.kucun.ui.activity.WebViewActivity;
...
public class NewStockUpDetailsAdapter extends BaseExpandableListAdapter {
    ...
    public NewStockUpDetailsAdapter(Context mcontext, String type,View rootView) {
     ...
     * 添加数据
     **/
    public void updata(List<StockUpDetailsModel.GatherListBean> groups) {
        this.mData = groups;
    ...
    public Object getChild(int groupPosition, int childPosition) {
        if (mData != null && mData.size() > 0) {
            List<StockUpDetailsModel.GatherListBean.DetailListBean> childs = mData.get(groupPosition).getDetailList();
