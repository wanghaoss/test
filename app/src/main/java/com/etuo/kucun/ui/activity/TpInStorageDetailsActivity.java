...
import com.etuo.kucun.ui.adapter.TpInStorageDetailsAdapter;
 ...
 * @version :
 * @date :2020/02/08
 * @ProjectNameDescribe :托盘入库 等详情操作界面
 * 修订历史：
 * ================================================
 */

public class TpInStorageDetailsActivity extends BaseActivity implements TpInStorageDetailsAdapter.OnClickBtItem {
    ...
    private TpInStorageDetailsAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        getData(true, true);
        mAdapter = new TpInStorageDetailsAdapter(this, fromType);
    ...
    public void getData(final boolean first, final boolean isPullDown) {
        ...
        if (!isPullDown) {
            if (end) {
                setRefreshList(isPullDown, new ArrayList<TpInStorageModel.GatherListBean>());
                return;
            } else {
        ...
        OkGo.get(UrlTools.getInterfaceUrl(TP_IN_STORAGE_GETBILL))
                ...
                .execute(new DialogCallback<LzyResponse<TpInStorageModel>>(this, "加载中..") {
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        ...
                        ShowToast.tCustom(TpInStorageDetailsActivity.this, e.getMessage());
                    }
                });
...
//                break;
    ...
    public void upLoadOrderComfrim() {
        LogUtil.d("token : " + PreferenceCache.getToken());
        OkGo.post(UrlTools.getInterfaceUrl(PALLET_SINGLE_OPERATION))
                .tag(this)
                .params("token", PreferenceCache.getToken())
                .params("palletStorageInId", NullToStr(orderId))
                ...
                .execute(new DialogCallback<LzyResponse<String>>(this, "加载中..") {
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        super.onError(call, response, e);
                        ShowToast.tCustom(TpInStorageDetailsActivity.this, NullToStr(e.getMessage()));
                    }
                });
    }
        ...
        OkGo.post(UrlTools.getInterfaceUrl(PALLET_BATCH_OPERATION))
                ...
                .execute(new DialogCallback<LzyResponse<String>>(this, "加载中..") {
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        ...
                        ShowToast.tCustom(TpInStorageDetailsActivity.this, e.getMessage().toString());
                    }
                });
    }
        ...
        if (!isOkByAllStatus(singleData.getDetailList(),"1")){
            PromptHintCancel p = new PromptHintCancel(this) {
                ...
                protected void onOk() {
                    ...
                    commitListBing(getCommitJosn(singleData.getDetailList(),"1"));
                }
            };
        ...
        if (!isOkByAllStatus(singleData.getDetailList(),"2")){
            PromptHintCancel p = new PromptHintCancel(this) {
                ...
                protected void onOk() {
                    ...
                    commitListBing(getCommitJosn(singleData.getDetailList(),"2"));
                }
            };
