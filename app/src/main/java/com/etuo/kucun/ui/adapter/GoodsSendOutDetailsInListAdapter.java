...
public class GoodsSendOutDetailsInListAdapter extends BaseAdapter {
    public static Context mContext;
    private LayoutInflater mInflater;
    private List<BomDetailsModel.GatherListBean.DetailListBean> mData;
    private String fromType;

    private OnClickBtItem onClickBtItem;


    public GoodsSendOutDetailsInListAdapter(Context context, List<BomDetailsModel.GatherListBean.DetailListBean> data, String fromType) {
        mContext = context;
