 ...
 * @ProjectNameDescribe :折叠listAdapter   转库
 * 修订历史：
 * ================================================
 */

public class NewChangeAreaDetailsAdapter extends BaseExpandableListAdapter {


    private List<ChangeAreaModel.GatherListBean> mData;
    ...
    public NewChangeAreaDetailsAdapter(Context mcontext, String type, View rootView) {
    ...
    public interface OnClickBtItem {
        void myOrderOkClick(int position, ChangeAreaModel.GatherListBean.DetailListBean singleData);
        void myOrderCancelClick(int position, ChangeAreaModel.GatherListBean.DetailListBean singleData);
    }
     ...
     * 添加数据
     **/
    public void updata(List<ChangeAreaModel.GatherListBean> groups) {
        this.mData = groups;
    ...
    public Object getChild(int groupPosition, int childPosition) {
        if (mData != null && mData.size() > 0) {
            List<ChangeAreaModel.GatherListBean.DetailListBean> childs = mData.get(groupPosition).getDetailList();
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_change_area, null);
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_change_area_list_status, null);
    ...
    class GroupViewHolder {
        ...
        TextView mTvTpFenqu;
        @BindView(R.id.tv_new_tp_fenqu)
        TextView mTvNewTpFenqu;
        ...
        void setData(final int positions, final ChangeAreaModel.GatherListBean singleData) {
            ...
            if (null != singleData.getGoods() && !mType.equals(ExtraConfig.IntentType.FROM_INTENT_CHANGE_AREA_BY_TP)) {
    ...
    class ChildViewHolder {
        ...
        TextView mTvKuquNum;
        @BindView(R.id.tv_new_kuqu_num)
        TextView mTvNewKuquNum;
        ...
        void setData(final int positions, final ChangeAreaModel.GatherListBean.DetailListBean singleData) {
            ...
            if (mType.equals(ExtraConfig.IntentType.FROM_INTENT_CHANGE_AREA_BY_TP)){
                mTvCargoInfo.setVisibility(View.VISIBLE);
                mTvCargoInfo.setText("数量 : " + singleData.getGoodsCnt()+" " + "重量 : "+singleData.getGoodsWeight() +"kg" );

            }else {
                mTvCargoInfo.setVisibility(View.GONE);
            }
            mTvKuquNum.setText(singleData.getStorageAreaName());
            //货物备货单状态：0待备货 1已备货
            mTvNewKuquNum.setText(singleData.getNewStorageAreaName());
