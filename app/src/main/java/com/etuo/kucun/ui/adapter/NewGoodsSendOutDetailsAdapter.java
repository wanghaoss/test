...
public class NewGoodsSendOutDetailsAdapter extends BaseExpandableListAdapter {
    ...
    public NewGoodsSendOutDetailsAdapter(Context mcontext, String type,View rootView) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_goods_send_out, null);
