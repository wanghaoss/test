...
public class TpBomDetailsAdapter extends BaseAdapter {

    public static Context mContext;
    private LayoutInflater mInflater;
    private List<BomDetailsModel.GatherListBean> mData;
    private GlideImageLoader mImageLoader;
    public static TpBomDetailsInListAdapter mAdapter ;
    private String mType;
    private OnClickBtItem onClickBtItem;


    public TpBomDetailsAdapter(Context context, String type) {
        mContext = context;
    ...
    class ViewHolder {
        ...
        void setData(final int positions, final BomDetailsModel.GatherListBean singleData) {
            ...
            mAdapter = new TpBomDetailsInListAdapter(mContext, mData.get(positions).getDetailList(),mType);
            mLvTpNumList.setAdapter(mAdapter);
            mAdapter.notifyDataSetChanged();
            mAdapter.OnClickBtItem(new TpBomDetailsInListAdapter.OnClickBtItem() {
                @Override
