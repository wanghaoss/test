...
public class TpBuyCheckDetailsAdapter extends BaseAdapter {

    public static Context mContext;
    private LayoutInflater mInflater;
    private List<BuyCheckDetailsModel.DetailListBean> mData;
    private GlideImageLoader mImageLoader;
    public static TpBuyCheckDetailsInListAdapter mAdapter ;
    private String mType;
    private OnClickBtItem onClickBtItem;


    public TpBuyCheckDetailsAdapter(Context context, String type) {
        mContext = context;
...
//                mTvOutWeight.setText(singleData.getChooseGoodsWeight()  +"kg");
            ...
            mAdapter = new TpBuyCheckDetailsInListAdapter(mContext, mData.get(positions).getBillDetailList(),mType);
            mLvTpNumList.setAdapter(mAdapter);
            mAdapter.notifyDataSetChanged();


            mAdapter.OnClickBtItem(new TpBuyCheckDetailsInListAdapter.OnClickBtItem() {
                @Override
                public void myOrderOkClick(int position, BuyCheckDetailsModel.DetailListBean.BillDetailListBean singleData) {
                    onClickBtItem.myOrderOkClick(positions,singleData);
                }

                @Override
                public void myOrderCancelClick(int position, BuyCheckDetailsModel.DetailListBean.BillDetailListBean singleData) {
