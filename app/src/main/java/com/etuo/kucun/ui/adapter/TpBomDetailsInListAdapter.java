...
/**
 * bom 出库 等的状态adapter 第二层
 * Created by yhn on 2020/02/07.
 */

public class TpBomDetailsInListAdapter extends BaseAdapter {
    ...
    public TpBomDetailsInListAdapter(Context context, List<BomDetailsModel.GatherListBean.DetailListBean> data, String fromType) {
        mContext = context;
