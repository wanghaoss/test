...
import com.etuo.kucun.ui.adapter.GoodsBuyInDetailsAdapter;
import com.etuo.kucun.ui.adapter.TpBuyCheckDetailsAdapter;
import com.etuo.kucun.ui.adapter.TpBuyCheckDetailsInListAdapter;
...
import static com.etuo.kucun.utils.UrlTools.PALLET_SINGLE_OPERATION;
...
public class GoodsBuyInDetailsActivity extends BaseActivity implements GoodsBuyInDetailsAdapter.OnClickBtItem {
    ...
    private GoodsBuyInDetailsAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvHeaderTitle.setText("采购入库");
        tvOrderNumText.setText("入库单号: ");

        initView();
        getData(true, true);
        mAdapter = new GoodsBuyInDetailsAdapter(this, fromType);
    ...
    public void getData(final boolean first, final boolean isPullDown) {
        ...
        if (!isPullDown) {
            if (end) {
                setRefreshList(isPullDown, new ArrayList<BuyInDetailsModel.GatherListBean>());
                return;
            } else {
        ...
        OkGo.get(UrlTools.getInterfaceUrl(GOODS_BUY_IN_GETBILL))
                ...
                .execute(new DialogCallback<LzyResponse<BuyInDetailsModel>>(this, "加载中..") {
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        ...
                        ShowToast.tCustom(GoodsBuyInDetailsActivity.this, e.getMessage());
                    }
                });
    ...
    public void upLoadOrderComfrim() {
        ...
        OkGo.post(UrlTools.getInterfaceUrl(GOODS_SINGLE_OPERATION))
                ...
                .execute(new DialogCallback<LzyResponse<String>>(this, "加载中..") {
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        super.onError(call, response, e);
                        ShowToast.tCustom(GoodsBuyInDetailsActivity.this, NullToStr(e.getMessage()));
                    }
                });
    }
        ...
        OkGo.post(UrlTools.getInterfaceUrl(GOODS_BATCH_ACCEPTANCE))
                ...
                .execute(new DialogCallback<LzyResponse<String>>(this, "加载中..") {
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        ...
                        ShowToast.tCustom(GoodsBuyInDetailsActivity.this, e.getMessage().toString());
                    }
                });
    }
