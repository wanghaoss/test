    ...
    private void buttonSetUp() {
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ftSubmit(getCommitJosn(submitList));
            }
        });
    }

    private void ftSubmit(String postJson) {
                ...
                .execute(new DialogCallback<LzyResponse<FTXQModel>>((Activity) mContext, "加载中") {
                    ...
                    public void onSuccess(LzyResponse<FTXQModel> responseData, Call call, Response response) {
                        if (responseData.data != null){
                            ...
                            sl = responseData.data.getReceiptCountInfo().getReceiptPalletList().get(0).getFullPalletQuantity();
...
//                });
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            ...
            return true;
        } else if (keyCode == FrameworkApp.KEY_SCAN && event.getRepeatCount() == 0) {//快捷键scan
            LogUtil.d("点击了 快捷扫描键");
            mBarcode2DUtil.ScanBarcode();
...
//    }
    ...
    public class AboutWorkAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            final FTActivity.ViewHolder holder;
