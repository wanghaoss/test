...
public class NewGoodsBuyInDetailsAdapter extends BaseExpandableListAdapter {
    ...
    public NewGoodsBuyInDetailsAdapter(Context mcontext, String type,View rootView) {
     ...
     * 添加数据
     **/
    public void updata(List<BuyInDetailsModel.GatherListBean> groups) {
        this.mData = groups;
    ...
    public Object getChild(int groupPosition, int childPosition) {
        if (mData != null && mData.size() > 0) {
            List<BuyInDetailsModel.GatherListBean.DetailListBean> childs = mData.get(groupPosition).getDetailList();
