...
import com.etuo.kucun.ui.adapter.TpStockUpDetailsAdapter;
...
public class TpStockUpDetailsActivity extends BaseActivity implements TpStockUpDetailsAdapter.OnClickBtItem {
    ...
    private TpStockUpDetailsAdapter mAdapter;
   ...
   private String buttonFlg;//能否操作数据  0 不能  1能
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new TpStockUpDetailsAdapter(this, fromType);
    ...
    public void getData(final boolean first, final boolean isPullDown) {
        ...
        if (!isPullDown) {
            if (end) {
                setRefreshList(isPullDown, new ArrayList<StockUpDetailsModel.GatherListBean>());
                return;
            } else {
...
//                            setRefreshList(isPullDown, responseData.bean.getGatherList());
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        ...
                        ShowToast.tCustom(TpStockUpDetailsActivity.this, e.getMessage());
                    }
                });
    ...
    private void setRefreshList(boolean isPullDown, List<StockUpDetailsModel.GatherListBean> result) {
        ...
        if (!StringUtil.isEmpty(checkOnePalletNum)){//选中
            ...
            mAdapter.updata(mOutBoundListModel,ints);

            mAdapter.notifyDataSetChanged();
            lvOutList.getRefreshableView().setSelection(ints[0]);
        }else {
            mAdapter.updata(mOutBoundListModel,null);
            mAdapter.notifyDataSetChanged();
        }
    ...
    public void upLoadOrderComfrim() {
        ...
        OkGo.post(UrlTools.getInterfaceUrl(UPDATE_BILL))
                ...
                .execute(new DialogCallback<LzyResponse<String>>(this, "加载中..") {
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        super.onError(call, response, e);
                        ShowToast.tCustom(TpStockUpDetailsActivity.this, NullToStr(e.getMessage()));
                    }
                });
    }
        ...
        OkGo.post(UrlTools.getInterfaceUrl(MOBILE_BINDING_GOODS))
                ...
                .execute(new DialogCallback<LzyResponse<String>>(this, "加载中..") {
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        ...
                        ShowToast.tCustom(TpStockUpDetailsActivity.this, e.getMessage().toString());
                    }
                });
    }
